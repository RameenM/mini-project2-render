...
sql_choice = st.selectbox("Choose example query:", ["None"] + list(sql_examples.keys()))
...
nl_examples = {
    ...
    "List customers with their country name": "List customers with their country name using correct joins"
}

nl_choice = st.selectbox("Choose example question:", ["None"] + list(nl_examples.keys()))
